    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (choice) {
            case 1:
                ...
                System.out.println("Human: Hp " + Human.healthpoint + " | Str " +Human.strenght + " | Def " + Human.defence);
                // Modify the stats
                break;
            case 2:
                ...
                System.out.println("Orc: Hp " + Orc.healthpoint + " | Str " +Orc.strenght + " | Def " + Orc.defence);
                 // Modify the stats
                break;
            case 3:
                ...
                System.out.println("Elf: Hp " + Elf.healthpoint + " | Str " +Elf.strenght + " | Def " + Elf.defence);
                 // Modify the stats
                break;
            case 4:
                ...
                System.out.println("Dwarf: Hp " + Dwarf.healthpoint + " | Str " +Dwarf.strenght + " | Def " + Dwarf.defence);
                 // Modify the stats
                break;
            default:
